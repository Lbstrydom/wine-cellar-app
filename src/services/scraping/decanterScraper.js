 ...
 * @module services/scraping/decanterScraper
 */

import logger from '../../utils/logger.js';
import { TIMEOUTS } from '../../config/scraperConfig.js';
import { BRIGHTDATA_API_URL } from '../search/searchConstants.js';
import { createTimeoutAbort } from '../shared/fetchUtils.js';
import { getLocaleParams } from '../search/queryBuilder.js';
  ...
  try {
    ...
    for (const url of reviewUrls) {
      ...
      if (reviewData && reviewData.score) {
        try {
          const { generateIdentityTokens, calculateIdentityScore } = await import('../wine/wineIdentity.js');
