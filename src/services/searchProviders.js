...
export { normaliseScore } from './scoreNormalization.js';
export { parseDrinkingWindow, parseVivinoWindow } from './drinkingWindowParser.js';
export { fetchPageContent } from './pageFetcher.js';
export {
  getCredentials,
  updateCredentialStatus,
  fetchDecanterAuthenticated,
  fetchAuthenticatedRatings
} from './authenticatedScraping.js';
...
import { calculateDiscoveryConfidence } from './fetchUtils.js';
import { inferCountryFromStyle } from './countryInference.js';
import { detectGrape } from './grapeDetection.js';
import { getSourcesForWine } from './sourceSelection.js';
import { searchGoogle } from './searchGoogle.js';
import {
  extractSearchTokens, buildSourceQuery, generateWineNameVariations
} from './nameProcessing.js';
