 ...
 */
router.get('/:id/tasting-notes', asyncHandler(async (req, res) => {
  const { id } = req.params;
 ...
 */
router.get('/:id/tasting-notes/sources', asyncHandler(async (req, res) => {
  const { id } = req.params;
 ...
 */
router.post('/:id/tasting-notes/regenerate', asyncHandler(async (req, res) => {
  const { id } = req.params;
 ...
 */
router.post('/:id/tasting-notes/report', asyncHandler(async (req, res) => {
  const { id } = req.params;
 ...
 */
router.put('/reports/:reportId', asyncHandler(async (req, res) => {
