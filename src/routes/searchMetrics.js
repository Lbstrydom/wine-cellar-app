 ...
 */
router.get('/search/summary', asyncHandler(async (req, res) => {
 ...
 * }
 */
router.post('/search/record', asyncHandler(async (req, res) => {
  const { summary, apiCalls, byDomain: _byDomain, byLens: _byLens, accuracy } = req.body;
 ...
 */
router.delete('/search/clear', asyncHandler(async (req, res) => {
 ...
 */
router.get('/search/accuracy', asyncHandler(async (req, res) => {
