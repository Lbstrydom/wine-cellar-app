...
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/styles.css?v=20260220c',
  '/css/variables.css?v=20260220c',
  '/css/layout.css?v=20260220c',
  '/css/components.css?v=20260220c',
  '/css/themes.css?v=20260220c',
  '/css/accessibility.css?v=20260220c',
  '/js/theme-init.js',
  '/js/app.js',
  '/js/api.js',
  '/js/utils.js',
