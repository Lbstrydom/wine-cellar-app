...
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/styles.css?v=20260222c',
  '/css/variables.css?v=20260222c',
  '/css/layout.css?v=20260222c',
  '/css/components.css?v=20260222c',
  '/css/themes.css?v=20260222c',
  '/css/accessibility.css?v=20260222c',
  '/js/theme-init.js',
  '/js/app.js',
  '/js/api.js',
  '/js/utils.js',
