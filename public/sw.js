...
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/styles.css?v=20260205g',
  '/css/variables.css?v=20260205g',
  '/css/layout.css?v=20260205g',
  '/css/components.css?v=20260205g',
  '/css/themes.css?v=20260205g',
  '/css/accessibility.css?v=20260205g',
  '/js/theme-init.js',
  '/js/app.js',
  '/js/api.js',
  '/js/utils.js',
