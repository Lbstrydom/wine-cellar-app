...
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/styles.css?v=20260222d',
  '/css/variables.css?v=20260222d',
  '/css/layout.css?v=20260222d',
  '/css/components.css?v=20260222d',
  '/css/themes.css?v=20260222d',
  '/css/accessibility.css?v=20260222d',
  '/js/theme-init.js',
  '/js/app.js',
  '/js/api.js',
  '/js/utils.js',
