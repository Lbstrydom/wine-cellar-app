...
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/styles.css?v=20260304b',
  '/css/variables.css?v=20260222e',
  '/css/layout.css?v=20260302b',
  '/css/components.css?v=20260305a',
  '/css/themes.css?v=20260222e',
  '/css/accessibility.css?v=20260222e',
  '/js/theme-init.js',
  '/js/app.js',
  '/js/api.js',
  '/js/utils.js',
  ...
  '/js/bottles/dropdownHelpers.js',
  '/js/config/wineRegions.js',
  '/js/grapeData.js',
  ...
  '/js/cellarAnalysis/zoneProposal.js',
  '/js/cellarAnalysis/zoneManagement.js',
  ...
  '/js/cellarAnalysis/placementIssues.js',
  '/js/cellarAnalysis/layoutDiffGrid.js',
  '/js/cellarAnalysis/layoutDiffControls.js',
  '/js/cellarAnalysis/layoutDiffDragDrop.js',
  '/js/cellarAnalysis/layoutDiffOrchestrator.js',
  '/js/onboarding.js',
  ...
  '/js/api/health.js',
  '/js/api/pairing.js',
  '/js/api/pendingRatings.js',
  '/js/api/foodPairings.js',
  ...
  '/js/recipes/profileSummary.js',
  '/js/recipes/categoryOverrides.js',
  '/js/recipes/menuBuilder.js',
  '/js/recipes/menuState.js',
  '/js/recipes/buyingGuide.js',
  '/js/recipes/cartState.js',
  '/js/recipes/cartPanel.js',
  '/js/recipes/wineResearch.js',
