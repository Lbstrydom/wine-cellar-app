...
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/styles.css?v=20260205f',
  '/css/variables.css?v=20260205f',
  '/css/layout.css?v=20260205f',
  '/css/components.css?v=20260205f',
  '/css/themes.css?v=20260205f',
  '/css/accessibility.css?v=20260205f',
  '/js/theme-init.js',
  '/js/app.js',
  '/js/api.js',
  '/js/utils.js',
