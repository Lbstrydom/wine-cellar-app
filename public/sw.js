...
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/css/styles.css?v=20260205b',
  '/css/variables.css?v=20260205b',
  '/css/layout.css?v=20260205b',
  '/css/components.css?v=20260205b',
  '/css/themes.css?v=20260205b',
  '/css/accessibility.css?v=20260205b',
  '/js/app.js',
  '/js/api.js',
  '/js/utils.js',
  '/js/grid.js',
